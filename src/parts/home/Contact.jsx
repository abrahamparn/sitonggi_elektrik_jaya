...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      // const subjectInput = formData.subject;
  ...
  return (
    <div className="md:py-20 bg-orange-500">
      <div className="grid md:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] ">
        <div>
          <h4 className="text-3xl font-extrabold" id="kontakKami">
            Hubungi Kami
          </h4>
          ...
          <div className="mt-12">
            ...
            <ul className="mt-3">
              <li className="flex items-center">
                ...
                <a
                  target="blank"
                  href=" mailto:sitonggie@yahoo.com?subject=Penawaran%20Produk&body=Halo%20Saya%20tertarik%20dengan%20produk%20sitonggi%20elektrik%20jaya%2C%20bisa%20kah%20saya%20ingin%20tahu%20lebih%20lanjut%3F "
